...
### Added
- **가입 이메일 도메인 화이트리스트 설계 (FEAT-AUTH-001 · REQ-AUTH-007)** — **문서만 작성함. 구현 대기.**
  ...
  - 문서 : `docs/99_inbox/01-requirements.md` · `03-roles.md` · `05-features.md` · `07-api.md` · `08-flowchart.md` · `10-scenarios.md`(TC-AUTH-001~011)
